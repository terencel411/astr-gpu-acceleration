program comparison
    ...
    if(choice == 1) then
        ...
        open(unit=20, file='gradcal_oa.txt', status='old', action='read')
        ...
        open(unit=20, file='convection_oa.txt', status='old', action='read')
        ...
        open(unit=20, file='diffusion_oa.txt', status='old', action='read')
        ...
        open(unit=20, file='filterq_oa.txt', status='old', action='read')
        ...
        open(unit=20, file='q2fvar_oa.txt', status='old', action='read')
        ...
        open(unit=20, file='bchomo_oa.txt', status='old', action='read')
